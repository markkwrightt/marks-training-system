                        ...
                        <div className="flex gap-1.5 print:hidden">
                            ...
                            {weekOffset > 0 && (
                                <button onClick={() => setWeekOffset(w => Math.max(0, w - 1))}
                                    className="bg-white/10 hover:bg-white/20 px-2 py-1 rounded-lg text-xs font-bold transition-colors">Next →</button>
                            )}
                        </div>
                    </div>
                                                ...
                                                return (
                                                    <div key={i} className="flex items-center justify-between bg-navy-900 px-3 py-2 rounded-lg text-xs">
                                                        <div className="flex items-center gap-1.5">
                                                            <span className="text-slate-300 font-bold">{g.count}× {g.ex.name}</span>
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            <span className="text-accent-green font-black">
                                                                ...
                                                                {g.bestReps && <span className="text-slate-400 font-bold ml-1">× {g.bestReps}</span>}
                                                            </span>
